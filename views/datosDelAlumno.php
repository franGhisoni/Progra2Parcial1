                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <img src="foto_alumno.jpg" alt="Foto del alumno" class="img-fluid rounded-circle mb-3" style="max-width: 250px;">
                            </div>
                            <h5 class="card-title text-center">Nombre Apellido</h5>
                            <p class="card-text text-center">Edad: 24 años</p>
                            <p class="card-text text-center">Correo electrónico: ejemplo@correo.com</p>
                            <p class="card-text text-center">Redes sociales:</p>
